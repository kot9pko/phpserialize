...
def test_loads_dict():
    assert phpserialize.loads(b'a:3:{s:1:"a";i:1;s:1:"c";i:3;s:1:"b";i:2;}') == {'a': 1, 'b': 2, 'c': 3}


def test_loads_unicode():
    assert phpserialize.loads(b's:23:"Bj\xc3\xb6rk Gu\xc3\xb0mundsd\xc3\xb3ttir";') == 'Björk Guðmundsdóttir'
